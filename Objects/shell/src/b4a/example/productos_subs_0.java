...
try {
		Debug.PushSubsStack("Create (productos) ","productos",2,__ref.getField(false, "ba"),__ref,12);
...
try {
		Debug.PushSubsStack("Delete (productos) ","productos",2,__ref.getField(false, "ba"),__ref,74);
...
try {
		Debug.PushSubsStack("Initialize (productos) ","productos",2,__ref.getField(false, "ba"),__ref,6);
...
try {
		Debug.PushSubsStack("Read_All (productos) ","productos",2,__ref.getField(false, "ba"),__ref,27);
...
try {
		Debug.PushSubsStack("Read_ById (productos) ","productos",2,__ref.getField(false, "ba"),__ref,50);
...
try {
		Debug.PushSubsStack("Update (productos) ","productos",2,__ref.getField(false, "ba"),__ref,69);
